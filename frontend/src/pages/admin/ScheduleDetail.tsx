  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-start justify-between gap-4">
        <div>
          <div className="flex items-center gap-2 text-sm text-gray-500 mb-1">
            <Link to="/admin/schedules" className="hover:text-blue-600">Schedules</Link>
            <span>/</span>
          ...
          <p className="text-sm text-gray-500 mt-1">
            ...
            {' · '}{schedule.shift_duration_hours}h · Capacity {schedule.capacity}
            {schedule.primary_team && <span className="ml-2 text-blue-600">· Primary: {schedule.primary_team.name}</span>}
          </p>
        </div>
      ...
      <div className="card p-5">
        <h2 className="font-semibold text-gray-900 mb-3">Manage Members</h2>
